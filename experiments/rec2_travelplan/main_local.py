...
if __name__ == "__main__":
    ...
    #parser.add_argument("--model", type=str, default="qwen-plus-2025-09-11")
    #parser.add_argument("--model", type=str, default="qwen3-max")
    parser.add_argument("--model", type=str, default="qwen3-4b-arena")
    parser.add_argument("--output", type=str, default="")
    parser.add_argument("--dataset", type=str, default="eval_40_dataset")
    ...
    if not tasks_to_run:
        ...
        test_agent = MultiTurnReactAgent(
            llm=llm_cfg,
            #function_list=["web_search", "search_flights","search_train_tickets","search_weather","search_navigation","search_poi","search_around"],
            system_message=SYSTEM_PROMPT.replace('<current_time>',datetime.now().strftime("%Y-%m-%d"))
        )
